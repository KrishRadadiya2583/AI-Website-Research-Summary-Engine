const STOPWORDS = new Set([
  ...
  'very',
  'was','wasnt','we','wed','well','were','werent','weve','what','whats','when','whens','where','wheres','which','while','who','whos','whom','why','whys','will','with','wont','would','wouldnt',
  'you','youd','youll','youre','youve','your','yours','yourself','yourselves',
  // web/nav noise
  'home','menu','click','read','learn','continue','skip','loading','copyright','rights','reserved','cookie','cookies','privacy','terms','policy','contact','subscribe','signup','login','signin','register',
]);
